...
export const CERTIFICATIONS = [
  ...
  },
  {
    ...
    link: 'https://www.coursera.org/account/accomplishments/certificate/FZ62GUT2W9SH',
    issuer: 'Imperial College London',
  },
  {
    date: 'May 2021',
    title: 'Mathematics in Machine Learning : Multi-variate Calculus',
    link: 'https://www.coursera.org/account/accomplishments/certificate/34MJUPARCKK3',
    issuer: 'Imperial College London',
  },
  {
    date: 'Apr 2021',
    title: 'Mathematics for Machine Learning : Linear Algebra',
    link: 'https://www.coursera.org/account/accomplishments/certificate/ZQ65HFFTW5MJ',
    issuer: 'Imperial College London',
  },
  {
    date: 'Apr 2021',
    title: 'Financial Planning for young adults',
    link: 'https://www.coursera.org/account/accomplishments/certificate/4Z64M65TSK2R',
    issuer: 'University of Illinois',
  },
  {
    date: 'Mar 2021',
    title: 'Problem Solving with Excel',
    link: 'https://www.coursera.org/account/accomplishments/certificate/UEB78RU7TPA3',
    issuer: 'PWC',
  },
  {
    date: 'Dec 2020',
    title: 'Build Better Generative Adversarial Networks (GANs)',
    link: 'https://www.coursera.org/account/accomplishments/certificate/7DMAUT934VA6',
    issuer: 'Deeplearning.ai',
  },
  {
    date: 'Dec 2020',
    title: 'Apply Generative Adversarial Networks (GANs)',
    link: 'https://www.coursera.org/account/accomplishments/certificate/6VPWB7Q4HWEX',
    issuer: 'Deeplearning.ai',
  },
  {
    date: 'Dec 2020',
    title: 'Build Basic Generative Adversarial Networks (GANs)',
    link: 'https://www.coursera.org/account/accomplishments/certificate/6ABG4X5XXS6B',
    issuer: 'Deeplearning.ai',
  },
  {
    date: 'Dec 2020',
    title: 'Recommendation Systems with TensorFlow on GCP',
    link: 'https://www.coursera.org/account/accomplishments/certificate/RXP625NK8WUY',
    issuer: 'Google Cloud',
  },
  {
    date: 'Dec 2020',
    title: 'SQL for Data Science',
    link: 'https://www.coursera.org/account/accomplishments/certificate/DCUBM7FT9LWL',
    issuer: 'UC Davis',
  },
  {
    date: 'Dec 2020',
    title: 'Sequences, Time Series and Prediction',
    link: 'https://www.coursera.org/account/accomplishments/certificate/4AD8MU8D6HNN',
    issuer: 'Deeplearning.ai',
  },
  {
    date: 'Nov 2020',
  ...
  },
  {
    ...
    link: 'https://www.coursera.org/account/accomplishments/certificate/QGPUSARQ7YPA',
    issuer: 'PWC',
  },
  {
    date: 'Nov 2020',
    title: 'Data Visualization with Advanced Excel',
    link: 'https://www.coursera.org/account/accomplishments/certificate/LCSJ7U8BDRCS',
    issuer: 'PWC',
  },
  {
    date: 'Sep 2020',
  ...
  },
  {
    ...
    link: 'https://www.coursera.org/account/accomplishments/certificate/ZZTSX7BKNJBB',
    issuer: 'Deeplearning.ai',
  },
  {
    date: 'Jul 2020',
    title: 'Introduction to Programming with MATLAB',
    link: 'https://www.coursera.org/account/accomplishments/certificate/JA3P53Y6CN9D',
    issuer: 'Vanderbuilt University',
  },
  {
    date: 'Jun 2020',
    title: 'Improving Deep Neural Networks: Hyperparameter tuning, Regularization and Optimization',
    link: 'https://www.coursera.org/account/accomplishments/certificate/JL9LWMNLT59L',
    issuer: 'Deeplearning.ai',
  },
  {
    date: 'Jun 2020',
    title: 'Convolutional Neural Networks',
    link: 'https://www.coursera.org/account/accomplishments/certificate/DY22Y5CY74UK',
    issuer: 'Deeplearning.ai',
  },
  {
    date: 'Jun 2020',
    title: 'Structuring Machine Learning Projects',
    link: 'https://www.coursera.org/account/accomplishments/certificate/NKUCPHNNM78F',
    issuer: 'Deeplearning.ai',
  },
  {
    date: 'Jun 2020',
    title: 'Data Analysis with Python',
    link: 'https://www.coursera.org/account/accomplishments/certificate/ZJVUM7UUZLK4',
    issuer: 'IBM',
  },
  {
    date: 'Jun 2020',
    title: 'Applied Data Science Capstone',
    link: 'https://www.coursera.org/account/accomplishments/certificate/G2DR9PABRXX7',
    issuer: 'IBM',
  },
  {
    date: 'Jun 2020',
    title: 'Data Visualization with Python',
    link: 'https://www.coursera.org/account/accomplishments/certificate/WJEYMSMX3H43',
    issuer: 'IBM',
  },
  {
    date: 'Jun 2020',
  ...
  },
  {
    ...
    link: 'https://www.coursera.org/account/accomplishments/certificate/HJ2P4ZPPM3AE',
    issuer: 'IBM',
  },
  {
    date: 'May 2020',
  ...
  },
  {
    ...
    link: 'https://www.coursera.org/account/accomplishments/certificate/4QDW9FHU385L',
    issuer: 'IBM',
  },
  {
    date: 'May 2020',
    title: 'Tools for Data Science',
    link: 'https://www.coursera.org/account/accomplishments/certificate/UHGE2HRH87GW',
    issuer: 'IBM',
  },
  {
    date: 'May 2020',
    title: 'Neural Networks and Deep Learning',
    link: 'https://www.coursera.org/account/accomplishments/certificate/PL8CW9DR5PLL',
    issuer: 'Deeplearning.ai',
  },
  {
    date: 'May 2020',
    title: 'Introduction to TensorFlow for Artificial Intelligence, Machine Learning, and Deep Learning',
    link: 'https://www.coursera.org/account/accomplishments/certificate/WKKTBNCX69QZ',
    issuer: 'Deeplearning.ai',
  },
  {
    date: 'Apr 2020',
    title: 'AWS Computer Vision: Getting Started with GluonCV',
    link: 'https://www.coursera.org/account/accomplishments/certificate/TYXLVBABHGRX',
    issuer: 'AWS',
  },
  {
    date: 'Apr 2020',
    title: 'Introduction to Data Science in Python',
    link: 'https://www.coursera.org/account/accomplishments/certificate/3ZME5TLBJ6M3',
    issuer: 'IBM',
  },
  {
    date: 'Apr 2020',
    title: 'What is Data Science?',
    link: 'https://www.coursera.org/account/accomplishments/certificate/TJGGCNGXT6UF',
    issuer: 'IBM',
  },
  {
    date: 'Apr 2020',
    title: 'Modernizing Data Lakes and Data Warehouses with GCP',
    link: 'https://www.coursera.org/account/accomplishments/certificate/L5MUTDQLGXZ9',
    issuer: 'Google Cloud',
  },
  {
    date: 'Apr 2020',
    title: 'Building Resilient Streaming Analytics Systems on GCP',
    link: 'https://www.coursera.org/account/accomplishments/certificate/P5HAT5LDMDD2',
    issuer: 'Google Cloud',
  },
  {
    date: 'Apr 2020',
    title: 'Building Batch Data Pipelines on GCP',
    link: 'https://www.coursera.org/account/accomplishments/certificate/8F7JHAXKG9KJ',
    issuer: 'Google Cloud',
  },
  {
    date: 'Apr 2020',
    title: 'Preparing for the Google Cloud Professional Data Engineer Exam',
    link: 'https://www.coursera.org/account/accomplishments/certificate/QTQFCVGBVDPL',
    issuer: 'Google Cloud',
  },
  {
    date: 'Apr 2020',
    title: 'Smart Analytics, Machine Learning, and AI on GCP',
    link: 'https://www.coursera.org/account/accomplishments/certificate/62GJPRAA8EQN',
    issuer: 'Google Cloud',
  },
  {
    date: 'Apr 2020',
    title: 'Google Cloud Platform Big Data and Machine Learning Fundamentals',
    link: 'https://www.coursera.org/account/accomplishments/certificate/JLJE4XUHEQZQ',
    issuer: 'Google Cloud',
  },
  {
    date: 'Oct 2021 - July 2022',
    title: 'Foundations of Modern Machine Learning',
    link: 'https://drive.google.com/file/d/1C-4Uw6dhaGik9G584lxwUhZx0GDnOLmE/view?usp=sharing',
    issuer: 'iHub Data - IIIT Hyderabad',
  },
  {
    date: 'Feb 2021',
    title: 'Online Short Term Course on Data Analytics using Python',
    link: 'https://drive.google.com/file/d/1SCC4qDiZyv_97QGOHYKFy9e8v7VRj4rI/view',
    issuer: 'National Institute of Technology, Warangal',
  },
  {
    date: '2020-2022',
    title: 'Credly Badges',
    link: 'https://www.credly.com/users/gokulakannan-sakthivel/badges',
    issuer: 'Credly',
  },
  {
    date: '2021',
    title: 'Qwiklabs - GCP',
    link: 'https://www.cloudskillsboost.google/public_profiles/fd9616ee-3e1b-425a-a806-eda63181c6a3',
    issuer: 'Google Cloud',
  },
  {
    date: '2020-2021',
    title: 'Qwiklabs - GCP',
    link: 'https://www.cloudskillsboost.google/public_profiles/29c19523-d5a6-43b5-a332-51560434fbc4',
    issuer: 'Google Cloud',
  },
  {
    date: 'Dec 2020',
    title: 'Movie Recommendation System using Collaborative Filtering',
    link: 'https://www.coursera.org/account/accomplishments/certificate/64LV574PW6ED',
    issuer: 'Coursera',
  },
  {
    date: 'Dec 2020',
    title: 'Building Recommendation System Using MXNET on AWS Sagemaker',
    link: 'https://www.coursera.org/account/accomplishments/certificate/HFQJ42HR9XXH',
    issuer: 'Coursera',
  },
  {
    date: 'Dec 2020',
    title: 'Traffic Sign Classification Using Deep Learning in Python/Keras',
    link: 'https://www.coursera.org/account/accomplishments/certificate/ANXLE6JBRVTX',
    issuer: 'Coursera',
  },
  {
    date: 'Dec 2020',
    title: 'Real-time OCR and Text Detection with Tensorflow, OpenCV and Tesseract',
    link: 'https://www.coursera.org/account/accomplishments/certificate/9TU7LRE7NNW4',
    issuer: 'Coursera',
  },
  {
    date: 'Dec 2020',
    title: 'Create Your First Web App with Python and Flask',
    link: 'https://www.coursera.org/account/accomplishments/certificate/L9AFRBMX9WY8',
    issuer: 'Coursera',
  },
  {
    date: 'Dec 2020',
    title: 'Web Scraping with Python + BeautifulSoup',
    link: 'https://www.coursera.org/account/accomplishments/certificate/63PLPW27G7SL',
    issuer: 'Coursera',
  },
  {
    date: 'Dec 2020',
    title: 'Video Basics with OpenCV and Python',
    link: 'https://www.coursera.org/account/accomplishments/certificate/WAQA2AJ3PS9E',
    issuer: 'Coursera',
  },
  {
    date: 'Dec 2020',
    title: 'Computer Vision - Object Tracking with OpenCV and Python',
    link: 'https://www.coursera.org/account/accomplishments/certificate/R2E8RD6N9TCZ',
    issuer: 'Coursera',
  },
  {
    date: 'Dec 2020',
    title: 'Computer Vision - Image Basics with OpenCV and Python',
    link: 'https://www.coursera.org/account/accomplishments/certificate/NZGHRRXXLBAH',
    issuer: 'Coursera',
  },
  {
    date: 'Nov 2020',
    title: 'Postman - Intro to APIs',
    link: 'https://www.coursera.org/account/accomplishments/certificate/XS9J393CRJ4A',
    issuer: 'Coursera',
  }
]
